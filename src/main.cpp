...
#include <vector>
#include <memory>
#include "GLViewExampleTerrainTesselationShader.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewExampleTerrainTesselationShader > glView( Aftr::GLViewExampleTerrainTesselationShader::New( args ) );
